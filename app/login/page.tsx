...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    // Simulate Google OAuth login - in production, this would redirect to Google OAuth
    ...
    try {
      ...
      storage.setToken(mockGoogleUser.token);
      storage.setUser(mockGoogleUser.user);
      router.push('/dashboard');
    } catch {
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-background">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 p-4 rounded-lg border border-border bg-card/50">
          <p className="text-xs text-muted-foreground mb-3 text-center font-medium">Demo Credentials</p>
